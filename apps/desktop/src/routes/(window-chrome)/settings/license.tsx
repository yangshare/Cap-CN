						...
						<div class="flex flex-col items-center p-6 mx-auto space-y-3 w-full max-w-md text-white rounded-3xl border bg-gray-2 border-gray-3">
							<div class="flex flex-col gap-2 items-center">
								<h3 class="text-2xl font-medium text-gray-12">
									{t("settings.license.pro.title")}
								</h3>
							</div>
							<p class="text-center text-gray-11">
								{t("settings.license.pro.bodyPre")}{" "}
								<span class="font-semibold text-blue-500">Cap Pro</span>{" "}
								{t("settings.license.pro.bodyPost")}
							</p>
						</div>
					</div>
				</Match>
						...
						<div class="p-8 mx-auto mt-6 w-full max-w-[700px] text-white rounded-xl border border-gray-3 bg-gray-2">
							<div class="space-y-6">
								<div class="flex flex-col gap-2 items-center mb-4 text-center">
									...
									<h3 class="text-2xl font-medium text-gray-12">
										{t("settings.license.commercial.title")}
									</h3>
								</div>
								<div>
									<label class="block mb-2 text-sm text-gray-12">
										{t("settings.license.commercial.keyLabel")}
									</label>
								...
								<Show when={license().expiryDate}>
									{(expiry) => (
										<div class="space-y-1">
											<label class="text-sm text-gray-12">{t("settings.license.commercial.expires")}</label>
								...
								<div class="flex flex-col items-center">
									...
									>
										{t("settings.license.commercial.deactivate")}
									</Button>
								</div>
							</div>
						</div>
				...
				{(generalSettings) => {
					...
					return (
						<div class="p-6 mx-auto w-full rounded-xl border text-gray-12 bg-gray-2 border-gray-3">
							<div class="space-y-3">
								<h3 class="mb-2 text-xl text-center">{t("settings.license.activate.title")}</h3>
								<Input
									placeholder={t("settings.license.activate.placeholder")}
									value={licenseKey()}
								...
								<div class="flex justify-center mt-4">
									...
									>
										{activateLicenseKey.isPending
											? t("settings.license.activate.activating")
					...
					>
						...
						<div class="space-y-1 text-center">
							<h3 class="text-2xl font-medium tracking-tight leading-5">
								{t("settings.license.purchase.title")}
							</h3>
							<p class="mt-2 text-sm text-(--text-tertiary)">
								{t("settings.license.purchase.subtitle")}
							</p>
						</div>
						<div class="flex flex-col justify-center items-center mt-5">
							...
							<p class="text-[16px] font-medium text-gray-11">
								{isCommercialAnnual()
									? t("settings.license.purchase.billedAnnually")
									: t("settings.license.purchase.oneTime")}
							</p>
						</div>
						<div
						...
						>
							<p class="text-xs text-gray-12">
								{t("settings.license.purchase.switchTo", {
									option: isCommercialAnnual()
										? t("settings.license.purchase.switchLifetime")
										: t("settings.license.purchase.switchYearly"),
						...
						>
							{openCommercialCheckout.isPending
								? t("settings.license.purchase.loading")
								: t("settings.license.purchase.button")}
						</Button>
					</div>
