...
const ACTION_KEY: Partial<Record<HotkeyAction, string>> = {
	startStudioRecording: "startStudio",
	startInstantRecording: "startInstant",
	restartRecording: "restart",
	stopRecording: "stop",
	togglePauseRecording: "togglePause",
	cycleRecordingMode: "cycleMode",
	openRecordingPicker: "openPicker",
	openRecordingPickerDisplay: "pickerDisplay",
	openRecordingPickerWindow: "pickerWindow",
	openRecordingPickerArea: "pickerArea",
...
function Inner(props: { initialStore: HotkeysStore | null }) {
	...
	const actions = () =>
		...
		] as const satisfies ReadonlyArray<HotkeyAction>;
									...
									<>
										<div class="flex flex-row justify-between items-center w-full h-8">
											<p class="text-[13px] text-gray-12">
												{t(`settings.hotkeys.actions.${ACTION_KEY[item()]}`)}
											</p>
											<Switch>
