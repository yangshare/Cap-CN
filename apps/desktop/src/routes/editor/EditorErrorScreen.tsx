				...
				<div class="max-w-md w-full space-y-6">
					<div class="flex flex-col items-center text-center space-y-3">
						...
						<h2 class="text-xl font-semibold text-gray-12">
							{needsRecovery()
								? t("editor.error.needsRecoveryTitle")
								: t("editor.error.unableToOpenTitle")}
						</h2>
						...
						<div class="bg-gray-2 border border-gray-4 rounded-xl p-4 space-y-4">
							<div class="space-y-2">
								<h3 class="font-medium text-gray-12 text-sm">
									{t("editor.error.automaticRecoveryTitle")}
								</h3>
								<p class="text-xs text-gray-11">
									{t("editor.error.automaticRecoveryDescription")}
								</p>
							</div>
								...
								<Show
									...
									fallback={
										<>
											...
											{t("editor.error.recoverRecording")}
										</>
									}
								>
									<IconLoaderCircle class="size-4 mr-2 animate-spin" />
									{t("editor.error.recovering")}
								</Show>
							</Button>
							...
							<Show when={recoverMutation.error}>
								<div class="bg-red-2 border border-red-6 rounded-lg p-3">
									<p class="text-red-11 text-xs">
										{t("editor.error.recoveryFailed", {
											error: recoverMutation.error instanceof Error
					...
					<div class="bg-gray-2 border border-gray-4 rounded-xl p-4 space-y-4">
						<div class="space-y-2">
							<h3 class="font-medium text-gray-12 text-sm">
								{t("editor.error.manualInvestigationTitle")}
							</h3>
							<p class="text-xs text-gray-11">
								{t("editor.error.manualInvestigationDescription")}
							</p>
								...
								<Show
									...
									fallback={
										<p class="text-xs text-gray-10 italic">
											{t("editor.error.tipDoubleClick")}
										</p>
									}
								>
									<p class="text-xs text-gray-10 italic">
										{t("editor.error.tipRightClick")}
									</p>
								</Show>
							</div>
						</div>
