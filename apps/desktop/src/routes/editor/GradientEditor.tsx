				...
				<div class="flex flex-col gap-3">
					...
					<div class="flex gap-3 items-end">
						<div class="flex-1 min-w-0">
							<span class="text-[11px] text-gray-10 mb-1 block">{t("editor.gradient.colorFrom")}</span>
						...
						<div class="flex-1 min-w-0">
							<span class="text-[11px] text-gray-10 mb-1 block">{t("editor.gradient.colorTo")}</span>
							<div class="flex flex-col gap-2">
								<RgbInput
									value={src().to}
									onChange={(to) => {
					...
					<Subfield name={t("editor.gradient.angle")} class="gap-4 items-center">
