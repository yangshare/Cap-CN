						...
						<div class="flex items-center justify-center gap-6 px-4 h-11">
							<Show when={!isMask()}>
								<ConfigItem
									label={
										type() === "text"
											? t("screenshotEditor.annotationConfig.color")
											: t("screenshotEditor.annotationConfig.stroke")
									}
								>
									<ColorPickerButton
							...
							<Show when={type() !== "text" && !isMask()}>
								<ConfigItem
									label={t("screenshotEditor.annotationConfig.width")}
							...
							<Show when={type() === "rectangle" || type() === "circle"}>
								<ConfigItem label={t("screenshotEditor.annotationConfig.fill")}>
									<ColorPickerButton
										value={ann().fillColor}
							...
							<Show when={!isMask()}>
								<ConfigItem
									label={t("screenshotEditor.annotationConfig.opacity")}
							...
							<Show when={type() === "mask"}>
								<ConfigItem label={t("screenshotEditor.annotationConfig.style")}>
									<div class="flex gap-1">
										...
										>
											{t("screenshotEditor.annotationConfig.blur")}
										</button>
										<button
											type="button"
											class={cx(
										...
										>
											{t("screenshotEditor.annotationConfig.pixelate")}
										</button>
									</div>
								</ConfigItem>
							</Show>
							...
							<Show when={type() === "mask"}>
								<ConfigItem
									label={t("screenshotEditor.annotationConfig.intensity")}
							...
							<Show when={type() === "text"}>
								<ConfigItem
									label={t("screenshotEditor.annotationConfig.size")}
							...
							>
								{t("screenshotEditor.annotationConfig.done")}
							</button>
						</div>
					</div>
				);
					...
					<div class="flex flex-col gap-2.5">
						...
						<div class="grid grid-cols-6 gap-1.5">
							<Show when={props.allowTransparent}>
								<Tooltip content={t("screenshotEditor.annotationConfig.transparent")}>
									<button
										type="button"
