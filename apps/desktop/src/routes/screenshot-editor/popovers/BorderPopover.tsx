	...
	return (
		...
		>
			<Popover.Anchor
				...
				tooltipText={t("screenshotEditor.popovers.border")}
				kbd={["E"]}
			/>
			<Popover.Portal>
					...
					<div class="flex flex-col gap-4">
						<div class="flex flex-row justify-between items-center">
							<span class="text-xs font-medium text-gray-11">
								{t("screenshotEditor.popovers.border")}
							</span>
							<Toggle
						...
						<Collapsible open={project.background.border?.enabled ?? false}>
							<Collapsible.Content class="overflow-hidden opacity-0 transition-opacity animate-collapsible-up data-expanded:animate-collapsible-down data-expanded:opacity-100">
								<div class="flex flex-col gap-4">
									<Field
										name={t("screenshotEditor.popovers.width")}
									...
									<Field
										name={t("screenshotEditor.popovers.color")}
									...
									<Field
										name={t("screenshotEditor.annotationConfig.opacity")}
